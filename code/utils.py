...
def traindata_sel(device, model, epochs, optimizer, train_dl, lamda=32,
              td=True, gamma=.5, alpha=.5, coverage=0.9, verbose=True,
    ...
    lamda : int
        The lambda parameter in SelectiveLoss. The default is 32
    td : bool
    ...
    alpha: float
        Value to determine the weights of auxiliary loss and selective loss. The default is .5
...
def traindata_sel_img(device, model, epochs, optimizer, train_dl, lamda=32,
              td=True, gamma=.5, alpha=.5, coverage=0.9, verbose=True,
              epochs_lr = [24,49,74,99,124,149,174,199,224,249,274,299]):
    """
...
def traindata_sat(device, model, epochs, optimizer, train_dl,
              ...
              pretrain=0, num_classes=3, reward=2):
    """
    ...
    crit : str
        ...
        The default is 'sat'.
    num_examples: int
        The number of examples to use for training. The default is 50000.
    pretrain : int
        The number of epochs for pretraining in SAT. The default is 0.
    num_classes: int
        The number of classes to predict. The default is 3.
    Returns
    -------
    model : torch.module
        The trained network.
...
def traindata_sat_img(device, model, epochs, optimizer, train_dl,
              td=True, gamma=.5, verbose=True,
              epochs_lr = [24,49,74,99,124,149,174,199,224,249,274,299], crit='sat', num_examples=50000,
